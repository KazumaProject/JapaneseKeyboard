...
interface QWERTYKeyMapHolder {
    ...
    val keysDefaultWithNumberRow: Set<QWERTYKey>
    fun getKeyInfoDefaultWithNumberRow(key: QWERTYKey): QWERTYKeyInfo

    val keysDefaultJPWithNumberRow: Set<QWERTYKey>
    fun getKeyInfoDefaultJPWithNumberRow(key: QWERTYKey): QWERTYKeyInfo
}
...
class QWERTYKeyMap : QWERTYKeyMapHolder {
    ...
    private val listDefaultWithNumberRow: Map<QWERTYKey, QWERTYKeyInfo> = mapOf(
        ...
        QWERTYKey.QWERTYKeyC to QWERTYKeyInfo.KeyC,
        QWERTYKey.QWERTYKeyD to QWERTYKeyInfo.KeyD,
        QWERTYKey.QWERTYKeyE to QWERTYKeyInfo.KeyENumber,
        QWERTYKey.QWERTYKeyF to QWERTYKeyInfo.KeyF,
        QWERTYKey.QWERTYKeyG to QWERTYKeyInfo.KeyG,
        QWERTYKey.QWERTYKeyH to QWERTYKeyInfo.KeyH,
        QWERTYKey.QWERTYKeyI to QWERTYKeyInfo.KeyINumber,
        QWERTYKey.QWERTYKeyJ to QWERTYKeyInfo.KeyJ,
        QWERTYKey.QWERTYKeyK to QWERTYKeyInfo.KeyK,
        QWERTYKey.QWERTYKeyL to QWERTYKeyInfo.KeyL,
        QWERTYKey.QWERTYKeyM to QWERTYKeyInfo.KeyM,
        QWERTYKey.QWERTYKeyN to QWERTYKeyInfo.KeyN,
        QWERTYKey.QWERTYKeyO to QWERTYKeyInfo.KeyONumber,
        QWERTYKey.QWERTYKeyP to QWERTYKeyInfo.KeyPNumber,
        QWERTYKey.QWERTYKeyQ to QWERTYKeyInfo.KeyQNumber,
        QWERTYKey.QWERTYKeyR to QWERTYKeyInfo.KeyRNumber,
        QWERTYKey.QWERTYKeyS to QWERTYKeyInfo.KeyS,
        QWERTYKey.QWERTYKeyT to QWERTYKeyInfo.KeyTNumber,
        QWERTYKey.QWERTYKeyU to QWERTYKeyInfo.KeyUNumber,
        QWERTYKey.QWERTYKeyV to QWERTYKeyInfo.KeyV,
        QWERTYKey.QWERTYKeyW to QWERTYKeyInfo.KeyWNumber,
        QWERTYKey.QWERTYKeyX to QWERTYKeyInfo.KeyX,
        QWERTYKey.QWERTYKeyY to QWERTYKeyInfo.KeyYNumber,
        QWERTYKey.QWERTYKeyZ to QWERTYKeyInfo.KeyZ,
        QWERTYKey.QWERTYKeyShift to QWERTYKeyInfo.KeyShift,
        QWERTYKey.QWERTYKeyDelete to QWERTYKeyInfo.KeyDelete,
        QWERTYKey.QWERTYKeySwitchDefaultLayout to QWERTYKeyInfo.KeySwitchDefaultLayout,
    ...
    private val listDefaultJP: Map<QWERTYKey, QWERTYKeyInfo> = mapOf(
        ...
        QWERTYKey.QWERTYKeyB to QWERTYKeyInfo.KeyBJP,
        QWERTYKey.QWERTYKeyC to QWERTYKeyInfo.KeyCJP,
        QWERTYKey.QWERTYKeyD to QWERTYKeyInfo.KeyDJP,
        QWERTYKey.QWERTYKeyE to QWERTYKeyInfo.KeyEJP,
        QWERTYKey.QWERTYKeyF to QWERTYKeyInfo.KeyFJP,
        QWERTYKey.QWERTYKeyG to QWERTYKeyInfo.KeyGJP,
        QWERTYKey.QWERTYKeyH to QWERTYKeyInfo.KeyHJP,
        QWERTYKey.QWERTYKeyI to QWERTYKeyInfo.KeyIJP,
        QWERTYKey.QWERTYKeyJ to QWERTYKeyInfo.KeyJJP,
        QWERTYKey.QWERTYKeyK to QWERTYKeyInfo.KeyKJP,
        QWERTYKey.QWERTYKeyAtMark to QWERTYKeyInfo.KeyLJP,
        QWERTYKey.QWERTYKeyL to QWERTYKeyInfo.KeyMinusJP,
        QWERTYKey.QWERTYKeyM to QWERTYKeyInfo.KeyMJP,
        QWERTYKey.QWERTYKeyN to QWERTYKeyInfo.KeyNJP,
        QWERTYKey.QWERTYKeyO to QWERTYKeyInfo.KeyOJP,
        QWERTYKey.QWERTYKeyP to QWERTYKeyInfo.KeyPJP,
        QWERTYKey.QWERTYKeyQ to QWERTYKeyInfo.KeyQJP,
        QWERTYKey.QWERTYKeyR to QWERTYKeyInfo.KeyRJP,
        QWERTYKey.QWERTYKeyS to QWERTYKeyInfo.KeySJP,
        QWERTYKey.QWERTYKeyT to QWERTYKeyInfo.KeyTJP,
        QWERTYKey.QWERTYKeyU to QWERTYKeyInfo.KeyUJP,
        QWERTYKey.QWERTYKeyV to QWERTYKeyInfo.KeyVJP,
        QWERTYKey.QWERTYKeyW to QWERTYKeyInfo.KeyWJP,
        QWERTYKey.QWERTYKeyX to QWERTYKeyInfo.KeyXJP,
        QWERTYKey.QWERTYKeyY to QWERTYKeyInfo.KeyYJP,
        QWERTYKey.QWERTYKeyZ to QWERTYKeyInfo.KeyZJP,
        QWERTYKey.QWERTYKeyShift to QWERTYKeyInfo.KeyShift,
        QWERTYKey.QWERTYKeyDelete to QWERTYKeyInfo.KeyDelete,
        QWERTYKey.QWERTYKeySwitchDefaultLayout to QWERTYKeyInfo.KeySwitchDefaultLayout,
        QWERTYKey.QWERTYKeySwitchMode to QWERTYKeyInfo.KeySwitchMode,
    ...
    private val listDefaultJPWithNumberRow: Map<QWERTYKey, QWERTYKeyInfo> = mapOf(
        ...
        QWERTYKey.QWERTYKeyC to QWERTYKeyInfo.KeyCJP,
        QWERTYKey.QWERTYKeyD to QWERTYKeyInfo.KeyDJP,
        QWERTYKey.QWERTYKeyE to QWERTYKeyInfo.KeyENumberJP,
        QWERTYKey.QWERTYKeyF to QWERTYKeyInfo.KeyFJP,
        QWERTYKey.QWERTYKeyG to QWERTYKeyInfo.KeyGJP,
        QWERTYKey.QWERTYKeyH to QWERTYKeyInfo.KeyHJP,
        QWERTYKey.QWERTYKeyI to QWERTYKeyInfo.KeyINumberJP,
        QWERTYKey.QWERTYKeyJ to QWERTYKeyInfo.KeyJJP,
        QWERTYKey.QWERTYKeyK to QWERTYKeyInfo.KeyKJP,
        QWERTYKey.QWERTYKeyAtMark to QWERTYKeyInfo.KeyLJP,
        QWERTYKey.QWERTYKeyL to QWERTYKeyInfo.KeyMinusJP,
        QWERTYKey.QWERTYKeyM to QWERTYKeyInfo.KeyMJP,
        QWERTYKey.QWERTYKeyN to QWERTYKeyInfo.KeyNJP,
        QWERTYKey.QWERTYKeyO to QWERTYKeyInfo.KeyONumberJP,
        QWERTYKey.QWERTYKeyP to QWERTYKeyInfo.KeyPNumberJP,
        QWERTYKey.QWERTYKeyQ to QWERTYKeyInfo.KeyQNumberJP,
        QWERTYKey.QWERTYKeyR to QWERTYKeyInfo.KeyRNumberJP,
        QWERTYKey.QWERTYKeyS to QWERTYKeyInfo.KeySJP,
        QWERTYKey.QWERTYKeyT to QWERTYKeyInfo.KeyTNumberJP,
        QWERTYKey.QWERTYKeyU to QWERTYKeyInfo.KeyUNumberJP,
        QWERTYKey.QWERTYKeyV to QWERTYKeyInfo.KeyVJP,
        QWERTYKey.QWERTYKeyW to QWERTYKeyInfo.KeyWNumberJP,
        QWERTYKey.QWERTYKeyX to QWERTYKeyInfo.KeyXJP,
        QWERTYKey.QWERTYKeyY to QWERTYKeyInfo.KeyYNumberJP,
        QWERTYKey.QWERTYKeyZ to QWERTYKeyInfo.KeyZJP,
        QWERTYKey.QWERTYKeyShift to QWERTYKeyInfo.KeyShift,
        QWERTYKey.QWERTYKeyDelete to QWERTYKeyInfo.KeyDelete,
        QWERTYKey.QWERTYKeySwitchDefaultLayout to QWERTYKeyInfo.KeySwitchDefaultLayout,
    ...
    override val keysDefaultWithNumberRow: Set<QWERTYKey>
        get() = listDefaultWithNumberRow.keys

    override fun getKeyInfoDefaultWithNumberRow(key: QWERTYKey): QWERTYKeyInfo {
        return listDefaultWithNumberRow.getOrDefault(key, QWERTYKeyInfo.Null)
    }

    override val keysDefaultJPWithNumberRow: Set<QWERTYKey>
        get() = listDefaultJPWithNumberRow.keys

    override fun getKeyInfoDefaultJPWithNumberRow(key: QWERTYKey): QWERTYKeyInfo {
        return listDefaultJPWithNumberRow.getOrDefault(key, QWERTYKeyInfo.Null)
    }
