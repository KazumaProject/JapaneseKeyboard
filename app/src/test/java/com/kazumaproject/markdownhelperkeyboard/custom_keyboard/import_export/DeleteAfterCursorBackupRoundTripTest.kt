...
class DeleteAfterCursorBackupRoundTripTest {

    @Test
    fun exportImportPreservesNormalAndFlickDeleteAfterCursorActions() {
        val action = KeyAction.DeleteAfterCursor
        ...
        val fullLayout = FullKeyboardLayout(
            layout = CustomKeyboardLayout(
                ...
                columnCount = 1,
                rowCount = 1,
                stableId = "backup-forward-delete"
            ),
