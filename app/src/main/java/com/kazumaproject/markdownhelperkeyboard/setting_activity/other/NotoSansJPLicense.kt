...
class NotoSansJPLicense : License() {
    ...
    override fun readSummaryTextFromResources(context: Context?): String {
        return "Copyright 2022 The Noto Project Authors (https://github.com/notofonts/latin-greek-cyrillic)\n" +
                "\n" +
    ...
    override fun getUrl(): String {
        return "https://github.com/notofonts/latin-greek-cyrillic"
    }
}