...
private val NUMBER_KEY_SMALL_LETTER_SYMBOL_CHAR = listOf('(',')','[',']')
...
fun MaterialTextView.setTextFlickRightNumber(
    ...
    when(keyId){
        ...
        R.id.key_small_letter ->{
            text = NUMBER_KEY_SMALL_LETTER_SYMBOL_CHAR[3].toString()
        }
    }
}
...
fun MaterialTextView.setTextFlickLeftNumber(
    ...
    when(keyId){
        ...
        R.id.key_small_letter ->{
            text = NUMBER_KEY_SMALL_LETTER_SYMBOL_CHAR[1].toString()
        }
    }
}
...
fun MaterialTextView.setTextFlickTopNumber(
    ...
    when(keyId){
        ...
        R.id.key_small_letter ->{
            text = NUMBER_KEY_SMALL_LETTER_SYMBOL_CHAR[2].toString()
        }
    }
}
...
fun MaterialTextView.setTextTapNumber(
    ...
    when(keyId){
        ...
        R.id.key_small_letter ->{
            text = NUMBER_KEY_SMALL_LETTER_SYMBOL_CHAR[0].toString()
        }
    }
}
